 ...
 */
public class BookManageFragment extends BaseFragment implements IRecycleViewItemClickListener {

    public static final String TAG = BookManageFragment.class.getSimpleName();
